...
SET BUILDCACHE=%APPVEYOR_BUILD_FOLDER%\dist\build\cache
SET BUILDDIR=%APPVEYOR_BUILD_FOLDER%\dist\build\%PROFILE%\%PLATFORM%
SET INSTDIR=%APPVEYOR_BUILD_FOLDER%\dist\build\%PROFILE%\%PLATFORM%
